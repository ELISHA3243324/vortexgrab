...
## ⚠️ BEFORE YOU START - Download yt-dlp

1. Go to: **https://github.com/yt-dlp/yt-dlp/releases/latest**
2. Scroll down to **Assets**
3. Download the file named exactly **`yt-dlp`** (no extension, about 3MB)
4. Put it in this folder (same place as server.js)
5. Delete the `PUT_YT-DLP_HERE.txt` file

Your folder should look like:
```
vortexgrab-render/
├── yt-dlp              ← THE FILE YOU DOWNLOADED
├── server.js
├── package.json
├── Dockerfile
├── public/
